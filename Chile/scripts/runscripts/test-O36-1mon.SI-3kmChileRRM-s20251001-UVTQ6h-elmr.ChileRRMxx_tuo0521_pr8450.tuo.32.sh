...
readonly CHECKOUT="ChileRRMxx_tuo0521_pr8450_c"
readonly BRANCH="jzhang/ChileRRMxx_tuo0521_pr8450_c"
readonly CHERRY=( )
...
#readonly run="32x1_nhoursx1_UVTQ1d-elmr-s20250101-O36"
readonly run="64x1_nmonthsx3_UVTQ6h-elmr-s20250101-O36"
  ...
  units=${tmp[1]%%x*}
  length=${tmp[1]##*x}
  #walltime="23:59:00" #6mon
  #walltime="16:59:00" #3mon
  walltime="04:30:00" #1mon
