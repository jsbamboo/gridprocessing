...
readonly RRMgrid="WP20ne32x32v1"
...
#readonly REST_N="1"
#readonly RESUBMIT="0"
readonly run="2240x1_ndaysx16_E3SMv1SSP585-UVTQ2d-s20151001-O40-5minAsite-rad3"
#readonly run="2240x1_nhoursx1_E3SMv1SSP585-UVTQ3h-s20151001-O40-5minAsite-rad3"
...
runtime_options() {
    ...
    cp ${YAML_ROOT}"/eamxx_wprrm.1dailyAVG_coarse_WP20.yaml" .
    ...
    #cp ${YAML_ROOT}"/eamxx_wprrm.1hI_1x1_155E175E-2.5N17.5N_debug.yaml" .
    ...
    cp ${YAML_ROOT}"/eamxx_wprrm.5minA_site_box_weighted_WP20.yaml" .
    cp ${YAML_ROOT}"/eamxx_wprrm.5minA_site_ocean_weighted_WP20.yaml" .
    cp ${YAML_ROOT}"/eamxx_wprrm.5minA_site_land_weighted_WP20.yaml" .
    cp ${YAML_ROOT}"/eamxx_wprrm.5minA_site_nearest_WP20.yaml" .
    #cp ${YAML_ROOT}"/eamxx_wprrm.5minI_1x1_155E175E-2.5N17.5N.yaml" .
    cp ${YAML_ROOT}"/eamxx_wprrm.25hI_pg2.yaml" .
    cp ${YAML_ROOT}"/eamxx_wprrm.1hI_1x1_155E175E-2.5N17.5N_Betts.yaml" .
    #cp ${YAML_ROOT}"/eamxx_wprrm.1hI_1x1_155E175E-2.5N17.5N_more.yaml" .
    ...
    ./atmchange output_yaml_files+="./eamxx_wprrm.1dailyAVG_coarse_WP20.yaml"
    ...
    #./atmchange output_yaml_files+="./eamxx_wprrm.1hI_1x1_155E175E-2.5N17.5N_debug.yaml"
    ...
    ./atmchange output_yaml_files+="./eamxx_wprrm.5minA_site_box_weighted_WP20.yaml"
    ./atmchange output_yaml_files+="./eamxx_wprrm.5minA_site_ocean_weighted_WP20.yaml"
    ./atmchange output_yaml_files+="./eamxx_wprrm.5minA_site_land_weighted_WP20.yaml"
    ./atmchange output_yaml_files+="./eamxx_wprrm.5minA_site_nearest_WP20.yaml"
    #./atmchange output_yaml_files+="./eamxx_wprrm.5minI_1x1_155E175E-2.5N17.5N.yaml"
    ./atmchange output_yaml_files+="./eamxx_wprrm.25hI_pg2.yaml"
    ./atmchange output_yaml_files+="./eamxx_wprrm.1hI_1x1_155E175E-2.5N17.5N_Betts.yaml"
    #./atmchange output_yaml_files+="./eamxx_wprrm.1hI_1x1_155E175E-2.5N17.5N_more.yaml"
    if [ "$units" == "nhours" ]; then
